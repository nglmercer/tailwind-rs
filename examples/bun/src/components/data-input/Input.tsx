...
export function InputDemo() {
  return (
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <label className="form-label">Email address<input className="form-input" name="email" placeholder="jordan@example.com" type="email" /><span className="form-help">We will only use this for account updates.</span></label>
